...
class NoteAPITest {
    ...
    @BeforeEach
    fun setup() {
        learnKotlin = Note("Learning Kotlin", 5, "College", "To do",false)
        summerHoliday = Note("Summer Holiday to France", 1, "Holiday", "done",false)
    ...
    inner class AddNotes {
        ...
        fun `adding a Note to a populated list adds to ArrayList`() {
            val newNote = Note("Study Lambdas", 1, "College", "Done",false)
    ...
    inner class UpdateNotes {
        ...
        fun `updating a note that does not exist returns false`(){
            assertFalse(populatedNotes!!.updateNote(6, Note("Updating Note", 2, "Work", "Doing",false)))
            assertFalse(populatedNotes!!.updateNote(-1, Note("Updating Note", 2, "Work", "To do",false)))
        ...
        fun `updating a note that exists returns true and updates`() {
            ...
            assertTrue(populatedNotes!!.updateNote(4, Note("Updating Note", 2, "College", "Done",false)))
